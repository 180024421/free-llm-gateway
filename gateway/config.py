...
def overview_payload(base_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "config": {
            ...
            "license_api_base": str(cfg.get("license_api_base") or "").strip(),
            "license_api_base_fallback": str(cfg.get("license_api_base_fallback") or "").strip(),
            "license_allow_insecure_http": bool(cfg.get("license_allow_insecure_http", False)),
        },
        "last_chat": last,
